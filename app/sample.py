...
with engine.connect() as connection:
    ...
    if result.fetchone() is None:
        rows = [
            {"id": 1, "stock_name": "Apple Inc.", "ticker": "AAPL", "market_cap": "2.5T", "price": "$150"},
            {"id": 2, "stock_name": "Microsoft Corp.", "ticker": "MSFT", "market_cap": "2.3T", "price": "$280"},
            {"id": 3, "stock_name": "Amazon.com Inc.", "ticker": "AMZN", "market_cap": "1.8T", "price": "$3500"},
            {"id": 4, "stock_name": "Alphabet Inc.", "ticker": "GOOGL", "market_cap": "1.6T", "price": "$2800"},
        ]
...
if stock_name_input:
    stmt = select(branch_stats_table).where(branch_stats_table.c.stock_name.ilike(f"%{stock_name_input}%"))
    ...
    if results:
        for result in results:
            stock_name, ticker, market_cap, price = result[1], result[2], result[3], result[4]
