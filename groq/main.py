        ...
        messages=[
            {
                ...
                "content": [
                    {
                        "type": "text",
                        "text": "Check if this image contains numeric data or financial information. If yes, provide the extracted data and only the financial insights, comma separated and nothing else. If no numeric or financial data is found, return 'This image is irrelevant for financial analysis.'"
                    },
                    {
                        "type": "image_url",
                        "image_url": {
